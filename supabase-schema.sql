...
DROP POLICY IF EXISTS "Anyone read notifications" ON notifications;
CREATE POLICY "Anyone read notifications"   ON notifications FOR SELECT USING (true);

DROP POLICY IF EXISTS "Anyone update notifications" ON notifications;
